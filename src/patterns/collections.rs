...
impl JazzPatterns {
    ...
    pub fn all() -> Vec<DrumPattern> {
        vec![Self::basic_swing(), Self::brushes_ballad()]
    }
}
...
impl LatinPatterns {
    ...
    pub fn all() -> Vec<DrumPattern> {
        vec![Self::bossa_nova(), Self::samba()]
    }
}
...
impl FunkPatterns {
    ...
    pub fn all() -> Vec<DrumPattern> {
        vec![Self::basic_funk(), Self::linear_funk()]
    }
}
...
impl PopPatterns {
    ...
    pub fn all() -> Vec<DrumPattern> {
        vec![Self::basic_pop(), Self::pop_ballad(), Self::ballad()]
    }
}
...
impl ElectronicPatterns {
    ...
    pub fn all() -> Vec<DrumPattern> {
        vec![Self::four_on_floor(), Self::breakbeat()]
    }
}
